...
namespace ModuloSeguridad.Models.Instituciones
{
    public class Empleo : DbContext
    {
        ...
        // esta cadena de conexión tiene como destino la base de datos 'ModuloSeguridad.Models.Instituciones.Empleo' de la instancia LocalDb. 
        // 
        ...
        public DbSet<empresa> Institucions { get; set; }
